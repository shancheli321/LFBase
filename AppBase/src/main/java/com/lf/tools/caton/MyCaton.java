...
public class MyCaton {
    ...
    private static final String TAG = "MyCaton=============";

    private static MyCaton sInstance = new MyCaton();
    ...
    public MyCaton() {
        HandlerThread logThread = new HandlerThread("MyCaton");
        logThread.start();
    ...
    public static MyCaton getInstance() {
        return sInstance;
    }
