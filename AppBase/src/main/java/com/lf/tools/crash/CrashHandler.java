...
//        String infomation = (String) AppSharePreferenceUtil.getString(SP_BUG, "");
//        //上传到自己的服务器
//        //失败保存到Sp  下次启动的时候判断是否有值 进行提交
//        if(infomation.length()>0){
//            //存储错误报告
//            AppSharePreferenceUtil.saveString(SP_BUG, bugInfomation.toString());
//        }
//        AppLog.e("未做上传服务器处理");
//        AppActivityManager.getActivityManager().AppExit();
    }
    ...
    public void collectDeviceInfo(Context ctx) {
        ...
        try {
            ...
            if (pi != null) {
                ...
                bugInfomation.append("应用名：").append(ctx.getPackageName()).append("\n");
