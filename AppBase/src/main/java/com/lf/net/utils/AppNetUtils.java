...
public class AppNetUtils {
    ...
    public static boolean isConnected() {
        ...
        ConnectivityManager cm = (ConnectivityManager) AppHttpUtils.getInstance().getmContext()
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) AppHttpUtils.getInstance().getmContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) AppHttpUtils.getInstance().getmContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
